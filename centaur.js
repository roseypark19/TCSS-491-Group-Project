class Centaur {
    ...
    constructor(game, x, y) {
        ...
        this.spritesheet = ASSET_MANAGER.getAsset("./sprites/enemies/centaur.png");
        ...
        if (this.state !== 4) {
            this.game.projectileEntities.forEach(entity => {
                if (entity.friendlyProjectile && this.hitBB.collide(entity.hitBB) && 
                    ...
                    ASSET_MANAGER.playAsset("./audio/dwarf_god_hit.mp3");
                    if (entity.elemental) {
                        switch(entity.type) {
                            case 0: // wind
                    ...
                    if (this.deadTimer === 0 && this.hp <= 0) {
                        ...
                        this.state = 4;
                        this.facing = [0, 0];
                        ASSET_MANAGER.playAsset("./audio/dwarf_god_death.mp3");
                    }
                }
            });
        }
