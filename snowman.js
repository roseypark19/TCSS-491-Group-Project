                        ...
                        if (this.shootTimer === 0) {
                            ...
                            if (this.shootFlag) {
                                this.game.addEntity(new Projectile(this.game, 
                                    ...
                                    this.BB.center.y - 16 * PARAMS.PROJECTILE_SCALE * 1.75 + 4 * Math.sin(snowballTheta) * PARAMS.PROJECTILE_SCALE * 1.75, snowballTheta, false, 17, this.BB.center, 50, PARAMS.PROJECTILE_SCALE * 1.75, 4));
                            }
                        }
                    }
                } else {
