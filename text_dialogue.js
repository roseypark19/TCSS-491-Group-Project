class Dialogue {
    ...
    constructor(game, text, isShowingOnCollision, textCenterX, textCenterY, bbX = -100, bbY = -100, bbWidth = 1, bbHeight = 1, isBlackText = false) {
        Object.assign(this, {game, text, isShowingOnCollision, textCenterX, textCenterY, bbX, bbY, bbWidth, bbHeight, isBlackText});
