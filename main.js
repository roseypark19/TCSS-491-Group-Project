...
ASSET_MANAGER.queueDownload("./audio/bow.mp3");
ASSET_MANAGER.queueDownload("./audio/whip.mp3");
ASSET_MANAGER.queueDownload("./audio/dwarves_hit.mp3");
ASSET_MANAGER.queueDownload("./audio/dwarves_death.mp3");
ASSET_MANAGER.queueDownload("./audio/beast_death.mp3");
ASSET_MANAGER.queueDownload("./audio/beholder_hit.mp3");
ASSET_MANAGER.queueDownload("./audio/beholder_death.mp3");
ASSET_MANAGER.queueDownload("./audio/bird_death.mp3");
ASSET_MANAGER.queueDownload("./audio/cubes_hit.mp3");
ASSET_MANAGER.queueDownload("./audio/cubes_death.mp3");
ASSET_MANAGER.queueDownload("./audio/djinn_hit.mp3");
ASSET_MANAGER.queueDownload("./audio/djinn_death.mp3");
ASSET_MANAGER.queueDownload("./audio/dragons_hit.mp3");
ASSET_MANAGER.queueDownload("./audio/dragons_death.mp3");
ASSET_MANAGER.queueDownload("./audio/druid_hit.mp3");
ASSET_MANAGER.queueDownload("./audio/dwarf_god_hit.mp3");
ASSET_MANAGER.queueDownload("./audio/dwarf_god_death.mp3");
ASSET_MANAGER.queueDownload("./audio/dwarves_hit.mp3");
ASSET_MANAGER.queueDownload("./audio/dwarves_death.mp3");
ASSET_MANAGER.queueDownload("./audio/flaming_skulls_hit.mp3");
ASSET_MANAGER.queueDownload("./audio/flaming_skulls_death.mp3");
ASSET_MANAGER.queueDownload("./audio/flayers_hit.mp3");
ASSET_MANAGER.queueDownload("./audio/flayers_death.mp3");
ASSET_MANAGER.queueDownload("./audio/hound_death.mp3");
ASSET_MANAGER.queueDownload("./audio/lizard_god_hit.mp3");
ASSET_MANAGER.queueDownload("./audio/lizard_god_death.mp3");
ASSET_MANAGER.queueDownload("./audio/mummies_hit.mp3");
ASSET_MANAGER.queueDownload("./audio/mummies_death.mp3");
ASSET_MANAGER.queueDownload("./audio/orc_hit.mp3");
ASSET_MANAGER.queueDownload("./audio/orc_death.mp3");
ASSET_MANAGER.queueDownload("./audio/scorpions_hit.mp3");
ASSET_MANAGER.queueDownload("./audio/scorpions_death.mp3");
ASSET_MANAGER.queueDownload("./audio/sprite_god_hit.mp3");
ASSET_MANAGER.queueDownload("./audio/sprite_god_death.mp3");
