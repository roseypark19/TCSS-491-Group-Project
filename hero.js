...
class Hero {
    ...
    constructor(game, x, y) {
        ...
        this.facing = [0, 0]; // down, up, right, left
                              // 0, 1, 0, 1 
        this.state = 0; // idle, walking, shooting, damaged, dead, spell projectile, spell explosion, spell shield
                        // 0, 1, 2, 3, 4, 5, 6
    ...
    loadAnimations() {
        ...
        this.animations.push(new AnimationGroup(this.spritesheet, 0, 0, 32, 32, 16, 0.1, false, true));
    ...
    update() {
        ...
        if (this.state !== 4 && !this.game.camera.title && !PARAMS.GAMEOVER) {
            ...
            //     this.animations[2].setFrameDuration(this.dexterity / 3);
                        ...
                        if (this.shootFlag) {
                            ...
                            // } else {
                                this.game.addEntity(new Projectile(this.game, 
                                                                   ...
                                                                   theta, true, WEAPONS[this.weapon.type].projectileType));
                            // }
    ...
    updateBB() {
        ...
        this.collisionBB = new BoundingBox(this.hitBB.x, this.hitBB.y + 4 * PARAMS.SCALE, 8 * PARAMS.SCALE, 8 * PARAMS.SCALE);
    };
