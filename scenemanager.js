            ...
            this.currentLevel.enemies.forEach(enemy => {
                switch (enemy.type) {
                    ...
                    case SwordedMinion:
                        ...
                        break;
                    case RangedMinion:
                        this.game.addEntity(new RangedMinion(this.game, enemy.x * PARAMS.BLOCKWIDTH * PARAMS.SCALE, enemy.y * PARAMS.BLOCKWIDTH * PARAMS.SCALE, enemy.minionType));
                        break;
                    case Troll:
...
class AbilityDisplay {
    ...
    draw(ctx) {
        ...
        if (saveState.numSpellsUnlocked > 0) {
            // frame shadow
